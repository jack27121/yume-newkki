...
app_surf = surface_check_create(app_surf,global.view_w,global.view_h);
view_set_surface_id(0,app_surf);

#region draws stuff beyond the room bounds
var edge_x1 = stanncam_x();
var edge_y1 = stanncam_y();
var edge_x2 = edge_x1+global.view_w;
var edge_y2 = edge_y1+global.view_h;
...
if(hor != 0 && ver != 0){
	...
	camera_set_view_size(cam_cor,global.view_w*obj_stanncam.zoom,global.view_h*obj_stanncam.zoom);
	outbounds_cor = surface_check_create(outbounds_cor,global.view_w,global.view_h);
...
if(ver != 0){
	...
	camera_set_view_size(cam_ver,global.view_w*obj_stanncam.zoom,global.view_h*obj_stanncam.zoom);
	outbounds_ver = surface_check_create(outbounds_ver,global.view_w,global.view_h);
